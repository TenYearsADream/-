...
// MedicAdminDoc.cpp : CMedicAdminDoc 类的实现
//
...
// 缩略图的支持
void CMedicAdminDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CMedicAdminDoc::InitializeSearchContent()
{
...
void CMedicAdminDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
